...
def perform_test(test_loader, model, test_meter, cfg, writer=None):
    ...
    f = open("./res_all2/dumb.txt","a")
    _prev_unique_video_idx = ""
    for cur_iter, (inputs, labels, video_idx, meta, _unique_video_idx) in enumerate(test_loader):
        ...
        if cfg.DETECTION.ENABLE:
            ...
            for i in range(video_idx_numpy.shape[0]):
                if str(labels_numpy[i]) != _prev_unique_video_idx:
                    ...
                    f.close()
                    filenamesm = "./res_all2/" + _prev_unique_video_idx +".txt"
